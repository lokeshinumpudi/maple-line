...
export const LEVEL_CROSSINGS = Object.freeze(
  [
    { id: 'sakuragawa-farm-road', name: 'Sakuragawa farm road', japanese: '桜川農道踏切', z: 1227 },
    ...
    { id: 'minato-harbour-road', name: 'Minato harbour road', japanese: '港道踏切', z: 20080 },
...
function chunkLattice(index) {
  ...
  if (regionalLakes.some((lake) => lake.z + lake.rz * 1.4 > start && lake.z - lake.rz * 1.4 < end))
  ...
  const rows = [];
  const step = (z) => (z >= 2560 && z <= 2660 ? 2 : 15);
